          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Whether you're just beginning to explore adoption or have
                specific questions about our services, we're here to help. Reach
                out via email, and a member of our team will reach out to you
                soon.
              </p> */}
