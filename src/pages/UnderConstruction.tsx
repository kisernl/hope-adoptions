...
const UnderConstruction = ({ 
  ...
  useEffect(() => {
    document.title = `${pageName} - Under Construction | LovelyAdopt`;
  }, [pageName]);
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div className="mb-8 flex justify-center loaded">
              <div className="relative">
                ...
                <Wrench size={48} className="text-brand-blue absolute bottom-0 right-0 animate-pulse" />
              </div>
            </div>
            
            <h2 className="heading-lg text-brand-navy mb-6 loaded">We're Building Something Special</h2>
            
            <div className="prose prose-blue mx-auto mb-12 space-y-4 text-gray-600 loaded">
              <p>
                Our team is hard at work creating this page to better serve your needs. 
                We appreciate your patience as we make improvements to enhance your experience.
              </p>
              <p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 loaded">
              ...
              <Link to="/contact">
                <Button variant="outline" className="border-brand-navy text-brand-navy hover:bg-brand-navy/5">
                  Contact Us
                </Button>
              </Link>
            </div>
