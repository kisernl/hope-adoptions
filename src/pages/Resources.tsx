  ...
  const educationalResources = [
    {
      ...
      description: "A comprehensive 6-week online course covering all aspects of the adoption process, attachment, transracial adoption considerations, and more.",
      type: "Online Course",
      link: "#"
    },
    {
      title: "Understanding Open Adoption",
      description: "An in-depth guide to navigating open adoption relationships with compassion and healthy boundaries.",
      type: "E-Book",
      link: "#"
    },
    {
      title: "Talking to Your Child About Adoption",
      description: "Age-appropriate strategies for discussing adoption with your child from toddlerhood through adolescence.",
      type: "Webinar",
      link: "#"
    },
    {
      title: "Financial Planning for Adoption",
      description: "A comprehensive guide to budgeting, tax credits, grants, and loans available for adoptive families.",
      type: "PDF Guide",
      link: "#"
    },
  ];
  ...
  const communityResources = [
    {
      ...
      description: "Monthly virtual meetings for adoptive parents to share experiences and support.",
      schedule: "First Tuesday of each month, 7:00-8:30 PM",
      link: "#"
    },
    {
      title: "Birth Parent Connection",
      description: "A supportive community for birth parents to connect and share their adoption journeys.",
      schedule: "Third Thursday of each month, 6:30-8:00 PM",
      link: "#"
    },
    {
      title: "Transracial Adoption Family Network",
      description: "Resources and community for families navigating the unique aspects of transracial adoption.",
      schedule: "Quarterly events and ongoing online forum",
      link: "#"
    },
    {
      title: "Teen Adoptee Group",
      description: "A safe space for adopted teens to connect with peers who share similar experiences.",
          ...
          <Tabs defaultValue="faq" className="w-full">
            ...
            <TabsContent value="faq" className="mt-4">
              <div className="bg-brand-pink/5 rounded-lg p-6 md:p-8">
                <h3 className="heading-md mb-6 text-brand-navy">Frequently Asked Questions</h3>
                <Accordion type="single" collapsible className="w-full">
                  {faqs.map((faq, index) => (
                    <AccordionItem key={index} value={`item-${index}`}>
                      <AccordionTrigger className="text-lg font-medium text-brand-navy hover:text-brand-blue">{faq.question}</AccordionTrigger>
            ...
            <TabsContent value="education" className="mt-4">
              <div className="bg-brand-pink/5 rounded-lg p-6 md:p-8">
                <h3 className="heading-md mb-6 text-brand-navy">Educational Resources</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {educationalResources.map((resource, index) => (
                    <Card key={index} className="transition-all hover:shadow-md border-none shadow-sm">
                      ...
                      <CardFooter>
                        <Button variant="outline" className="text-brand-blue border-brand-blue hover:bg-brand-blue/10 w-full" asChild>
                          <a href={resource.link} target="_blank" rel="noreferrer">
                            {resource.type === "Webinar" || resource.type === "Online Course" ? (
                              <BookOpen className="mr-2 h-4 w-4" />
                            ) : (
                              <Download className="mr-2 h-4 w-4" />
                            )}
                            {resource.type === "Webinar" || resource.type === "Online Course" ? "Access" : "Download"}
                          </a>
                        </Button>
                      </CardFooter>
                    </Card>
            ...
            <TabsContent value="community" className="mt-4">
              <div className="bg-brand-pink/5 rounded-lg p-6 md:p-8">
                <h3 className="heading-md mb-6 text-brand-navy">Community Support</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section className="section-padding bg-brand-lightBlue/10">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <h2 className="heading-lg mb-4 text-brand-navy">Adoption Guides & Checklists</h2>
            <p className="subheading">
              Download our comprehensive adoption resources to help you navigate each stage of your journey.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm transition-all hover:shadow-md">
              <h3 className="text-xl font-serif font-semibold mb-3 text-brand-navy">Getting Started Guide</h3>
              <p className="text-gray-600 mb-6">A comprehensive overview of the adoption process, from initial decision-making to post-placement.</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm transition-all hover:shadow-md">
              <h3 className="text-xl font-serif font-semibold mb-3 text-brand-navy">Home Study Checklist</h3>
              <p className="text-gray-600 mb-6">A detailed checklist of everything you need to prepare for a successful home study process.</p>
              <Button className="w-full">
                <Download className="mr-2 h-4 w-4" />
                Download PDF
              </Button>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm transition-all hover:shadow-md">
              <h3 className="text-xl font-serif font-semibold mb-3 text-brand-navy">Financial Planning Worksheet</h3>
              <p className="text-gray-600 mb-6">A worksheet to help you plan for adoption costs, tax benefits, and available financial resources.</p>
              <Button className="w-full">
                <Download className="mr-2 h-4 w-4" />
                Download PDF
              </Button>
